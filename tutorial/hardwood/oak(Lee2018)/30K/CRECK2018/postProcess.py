...
# Read the mass0
mass0Open = open("50/lagrangian/coalCloud1/mass0")
mass0 = float(mass0Open.readlines()[17].split(')')[0].replace("1(", ""))

# The ash mass
ashOpen = open("50/lagrangian/coalCloud1/Yash(s)")
mAsh = 0#float(ashOpen.readlines()[17].split(')')[0].replace("1(", "")) * mass0
...
#plt.plot(numT, numMassLoss, 'o', label="old simulation mass loss")
plt.xlabel('Temperature (K)')
