...
)
{
    ...
    Info << "after call calcDevolatilisation " << nl;
    ...
    forAll(dMassDV, i)
    {
        ...
        // Info << dMassDV << nl;
        // Info << "test ID !!!!!" << i << nl;
        // if(composition.componentNames(GAS)[i] == "H2"||"H2O"||"CO"||"CO2"|| 
        //     "CH2O"||"HCOOH"||"CH4"||"CH3OH"||"C2H2O2"||"C2H4"||"CH3CHO"||
        //     "C2H4O2"||"C2H5OH"||"C2H3CHO"||"C2H5CHO"||"C5H8O4"||"C6H5OH"||
        //     "C6H6O3")
        // {
        //     mGas1_ -= dMassDV[i];
        // }
        mGas1_ -= dMassDV[i];
        // Info << composition.componentNames(GAS)[i] << nl;
    }
    ...
    scalarField dMassSolid(dMassSRSolid+dMassSOLID);
    scalar mass1 =
